...
(function(h) {
    ...
    function ha(a) {
        ...
        if (a.bInitialised) {
            ...
            c.bAutoWidth && Fa(a);
            b = 0;
            for (c = e.length; b < c; b++) f = e[b], f.sWidth && (f.nTh.style.width = v(f.sWidth, "f.sWidth"));
            r(a, null, "preInit", [a]);
            T(a);
            e = y(a);
    ...
    function rb(a) {
        ...
        i = h("<div/>", {
            ...
            position: "relative",
            border: 0,
            width: d ? !d ? null : v(d, "f.sScrollHead") : "100%"
        }).append(h("<div/>", {
            ...
            position: "relative",
            overflow: "auto",
            width: !d ? null : v(d,"f.sScrollBody")
        }).append(b));
        l && i.append(h("<div/>", {
            "class": f.sScrollFoot
        }).css({
            overflow: "hidden",
            border: 0,
            width: d ? !d ? null : v(d,"f.sScrollFoot") : "100%"
        }).append(h("<div/>", {
    ...
    function la(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, $(a);
            ...
            if ("" === c) {
                r.width = "100%";
                if (U && (p.find("tbody").height() > j.offsetHeight || "scroll" == l.css("overflow-y"))) r.width = v(p.outerWidth() - b, "r.width");
                f = p.outerWidth()
            } else "" !== d && (r.width = v(d, "r.width"), f = p.outerWidth());
            I(C, L);
            I(function(a) {
                z.push(a.innerHTML);
                Ua.push((v(h(a).css("width"), "Ua.push") == "208.203px") ? "500px" : v(h(a).css("width"), "Ua.push"));
            }, L);
            I(function(a, b) {
            ...
            c = p.outerWidth();
            m[0].style.width = (v(c,"m.style.width") == "874px" ? "100%" : v(c,"m.style.width"));
            i.width = (v(c,"i.width") == "874px" ? "100%" : v(c,"i.width"));
            d = p.height() > j.clientHeight || "scroll" == l.css("overflow-y");
            e = "padding" + (x.bScrollbarLeft ? "Left" : "Right");
            i[e] = d ? b + "px" : "0px";
            u && (n[0].style.width = v(c,"n.style.width"), t[0].style.width = v(c,"t.style.width"), t[0].style[e] = d ? b + "px" : "0px");
    ...
    function Fa(a) {
        ...
        if (d || !t && !f && !e && j == V(a) && j == m.length)
            ...
            for (n = 0; n < i.length; n++) o = c[i[n]], m[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? v(o.sWidthOrig, "o.sWidthOrig") : "", o.sWidthOrig && f && h(m[n]).append(h("<div/>").css({
                width: o.sWidthOrig,
                margin: 0,
                padding: 0,
                border: 0,
            ...
            for (n = e = 0; n < i.length; n++) k = h(m[n]), g = k.outerWidth() - k.width(), k = p.bBounding ? Math.ceil(m[n].getBoundingClientRect().width) : k.outerWidth(), e += k, c[i[n]].sWidth = v(k - g, "c.i.n.sWidth");
            b.style.width = (v(e,"b.style.width") == "874px" ? "100%" : v(e,"b.style.width"));
            o.remove()
        }
        l && (b.style.width = v(l));
    ...
    function v(a, flg = "nothing") {
    		var b = 0;
    		b = null === a ? "0px" : "number" == typeof a ? 0 > a ? "0px" : a + "px" : a.match(/\d$/) ? a + "px" : a;    		
    		//console.log(flg + " is " + b);
        return b;
    }
